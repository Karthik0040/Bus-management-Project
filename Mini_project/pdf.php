              ...
              <div class="card d-flex flex-column align-items-center text-center p-4">
                ...
                <div class="d-flex flex-column align-items-center text-center">
                  <div class="mt-4 mb-3">
                    ...
                    <p class="text-secondary mb-1"><?php echo "$usn"; ?></p>
                ...
                <ul class="list-group list-group-flush">
                  ...
                  <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                    ...
                    <span class="text-secondary"><?php echo "$gender"; ?></span>
                  </li>
                  <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                ...
                <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                  <h6 class="mb-0"><span class="fa fa-money mr-3 pe-2"></span>Issued On</h6>
                  <span class="text-secondary">
                    <?php echo "$issued"; ?>
                  </span>
                </li>
                <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                  <h6 class="mb-0"><span class="fa fa-money mr-3 pe-2"></span>Valid Till</h6>
                  <span class="text-secondary">
                    <?php echo "$validity"; ?>
                  </span>
                </li>
